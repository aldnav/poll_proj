...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Voter'
        db.create_table(u'polls2_voter', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ip', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('poll', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['polls2.Poll'])),
            ('choice', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['polls2.Choice'])),
        ))
        db.send_create_signal(u'polls2', ['Voter'])

        # Adding model 'Poll'
        db.create_table(u'polls2_poll', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=50)),
            ('question', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('pub_date', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal(u'polls2', ['Poll'])

        # Adding model 'Choice'
        db.create_table(u'polls2_choice', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('poll', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['polls2.Poll'])),
            ('choice_text', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('votes', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'polls2', ['Choice'])


    def backwards(self, orm):
        # Deleting model 'Voter'
        db.delete_table(u'polls2_voter')

        # Deleting model 'Poll'
        db.delete_table(u'polls2_poll')

        # Deleting model 'Choice'
        db.delete_table(u'polls2_choice')
