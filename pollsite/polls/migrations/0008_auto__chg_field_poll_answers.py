...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Poll.answers'
        db.alter_column(u'polls_poll', 'answers', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'Poll.answers'
        db.alter_column(u'polls_poll', 'answers', self.gf('django.db.models.fields.IntegerField')(null=True))
